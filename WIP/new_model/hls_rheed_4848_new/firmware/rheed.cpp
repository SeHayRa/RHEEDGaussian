...
void rheed(
    ...
    #pragma HLS STREAM variable=layer2_out depth=1936
    nnet::conv_2d_cl<input_t, layer2_t, config2>(x, layer2_out, w2, b2); // layer1_0

    hls::stream<layer4_t> layer4_out("layer4_out");
    #pragma HLS STREAM variable=layer4_out depth=1936
    ...
    #pragma HLS STREAM variable=layer6_out depth=49
    nnet::conv_2d_cl<layer5_t, layer6_t, config6>(layer5_out, layer6_out, w6, b6); // layer2_0

    hls::stream<layer8_t> layer8_out("layer8_out");
    #pragma HLS STREAM variable=layer8_out depth=49
